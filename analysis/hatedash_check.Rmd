...
The 'Brexit' data collection is running since April 2019 on the dashboard. When we select dates from September 01 to September 31, we get the following visualisation.

```{r pressure, echo=FALSE, fig.cap="September 2019 from HSD", out.width = '100%'}
library(png)
knitr::include_graphics(here::here("/output/HSD_Brexit_Sep19.png"))
```
